...
{
	xml_details = [[NSString stringWithFormat:@"<EventInfoResponse><StatusMessage>%@</StatusMessage></EventInfoResponse>", statusMessages[status]] cStringUsingEncoding:NSUTF8StringEncoding];
}
